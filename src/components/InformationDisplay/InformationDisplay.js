      ...
      <div className="InformationDisplay_Wrapper">
        ...
        <section className="InformationDisplay_Section">
            ...
            <ul>
                ...
                <li><b>1d20+1d4</b> (Multiple dice of different sizes)</li>
                <li><b>2d20</b> (Multiple dice of the same size)</li>
                <li><b>1d20+5</b> (One or more dice + Modifier)</li>
                <li><b>2d20adv</b> (Multiple dice of the same size with adventage)</li>
                <li><b>2d20dis</b> (Multiple dice of the same size with disadventage)</li>
